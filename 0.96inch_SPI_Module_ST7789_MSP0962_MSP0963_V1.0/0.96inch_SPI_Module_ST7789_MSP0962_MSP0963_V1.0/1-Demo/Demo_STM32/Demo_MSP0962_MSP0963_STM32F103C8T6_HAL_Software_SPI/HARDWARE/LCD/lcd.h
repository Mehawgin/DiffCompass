...
#define LCD_CS_PIN    GPIO_PIN_9   //片选引脚            PB9

//RS引脚定义
#define LCD_RS_PORT   GPIOB  
#define LCD_RS_PIN    GPIO_PIN_7   //寄存器/数据选择引脚 PB7 

//RST引脚定义
#define LCD_RST_PORT  GPIOB  
#define LCD_RST_PIN   GPIO_PIN_8   //复位引脚            PB8
...
//GPIO复位（拉低）
#define LCD_BL_CLR  LCD_BL_PORT->BRR=LCD_BL_PIN			 //BL引脚拉低				    
#define	LCD_CS_CLR  LCD_CS_PORT->BRR=LCD_CS_PIN      //CS引脚拉低  	
#define	LCD_RS_CLR	LCD_RS_PORT->BRR=LCD_RS_PIN      //RS引脚拉低  	 
#define	LCD_RST_CLR	LCD_RST_PORT->BRR=LCD_RST_PIN    //RST引脚拉低  
