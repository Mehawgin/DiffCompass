...
void Pic_test(void)
{
	DrawTestPage("图片显示测试");
	//LCD_Fill(0,20,lcddev.width,lcddev.height-20,WHITE);
	//ui_Drawbmp16(50,90,40,40,gImage_qq);
...
//  {
//    LCD_DrawRectangle(20*i, 0, 20, 240);
//	LCD_DrawFillRectangle(20*i, 0, 20, 240);
//    //LCD_Fill(20*i, 0, 20, 240, BLACK);
	
////    LCD_Fill(0, 20*i, 20, 240, 0xe374);
////    delay_ms(10);
//  }
	


  	LCD_Fill(0, 0, 240, 240, 0xe374);
  	Gui_Drawbmp16(72, 70, 95, 77, gImage_ashin_eye_stm32);
	delay_ms(1500);
...
//  Gui_Drawbmp16(72, 70, 95, 77, Ming);
//  delay_ms(500);
//  Gui_Drawbmp16(72, 70, 95, 77, Ming_Blink1);
//  delay_ms(30);
//  Gui_Drawbmp16(72, 70, 95, 77, Ming_Blink2);
//  delay_ms(30);
//  Gui_Drawbmp16(72, 70, 95, 77, Ming_Blink3);
//  delay_ms(30);
//  Gui_Drawbmp16(72, 70, 95, 77, Ming_Blink4);
//  delay_ms(30);
//  Gui_Drawbmp16(72, 70, 95, 77, Ming_Blink3);
//  delay_ms(30);
//  Gui_Drawbmp16(72, 70, 95, 77, Ming);
...
//    Gui_Drawbmp16(72, 70, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 127, 240, 20);
//    LCD_DrawFillRectangle(0, 127, 240, 20);
//    Gui_Drawbmp16(72, 50, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 107, 240, 20);
//    LCD_DrawFillRectangle(0, 107, 240, 20);
//    Gui_Drawbmp16(72, 30, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 87, 240, 20);
//    LCD_DrawFillRectangle(0, 87, 240, 20);
//    Gui_Drawbmp16(72, 10, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 10, 240, 20);
//    LCD_DrawFillRectangle(0, 10, 240, 20);
//    Gui_Drawbmp16(72, 30, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 30, 240, 20);
//    LCD_DrawFillRectangle(0, 30, 240, 20);
//    Gui_Drawbmp16(72, 50, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 50, 240, 20);
//    LCD_DrawFillRectangle(0, 50, 240, 20);
//    Gui_Drawbmp16(72, 70, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 70, 240, 20);
//    LCD_DrawFillRectangle(0, 70, 240, 20);
//    Gui_Drawbmp16(72, 90, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 90, 240, 20);
//    LCD_DrawFillRectangle(0, 90, 240, 20);
//    Gui_Drawbmp16(72, 110, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 167, 240, 20);
//    LCD_DrawFillRectangle(0, 167, 240, 20);
//    Gui_Drawbmp16(72, 90, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//    LCD_DrawRectangle(0, 147, 240, 20);
//    LCD_DrawFillRectangle(0, 147, 240, 20);
//    Gui_Drawbmp16(72, 70, 95, 77, gImage_ashin_eye_stm32);
//    delay_ms(40);
//  }
//  delay_ms(500);
