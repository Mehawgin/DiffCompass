...
#define LGFX_PRINTF_ENABLED
  ...
  public:
    ...
    /// @a setBaseColor ctg added on 2022-9-3
    LGFX_INLINE_T void setBaseColor(T c) { _base_rgb888 = hasPalette() ? c : convert_to_rgb888(c); _panel->setCtgPanelBaseColour(_base_rgb888); }
    /// @a setBaseColor ctg added on 2022-9-3
    LGFX_INLINE   void setBaseColor(uint8_t r, uint8_t g, uint8_t b) { setBaseColor(lgfx::color888(r,g,b)); }
