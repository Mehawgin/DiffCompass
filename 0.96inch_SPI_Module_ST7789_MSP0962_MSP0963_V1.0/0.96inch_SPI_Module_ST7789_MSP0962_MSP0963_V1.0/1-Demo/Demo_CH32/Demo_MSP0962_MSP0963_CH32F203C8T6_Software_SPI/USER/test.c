...
void Test_Color(void)
{
	...
	Show_Str(40,30,BLACK,YELLOW,"WHITE",16,1);Delay_Ms(800);
	LCD_Fill(0,0,lcddev.width-1,lcddev.height-1,BLACK);
	Show_Str(40,30,WHITE,YELLOW,"BLACK",16,1);Delay_Ms(800);
	...
	Show_Str(40,30,RED,YELLOW,"GRAY",16,1);Delay_Ms(800);
}
