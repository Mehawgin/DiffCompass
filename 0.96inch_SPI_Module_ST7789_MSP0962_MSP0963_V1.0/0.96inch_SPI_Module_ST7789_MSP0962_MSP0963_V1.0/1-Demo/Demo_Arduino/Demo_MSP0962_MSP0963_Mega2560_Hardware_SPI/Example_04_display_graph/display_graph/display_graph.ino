...
void text_test()
{
  ...
  mylcd.Print_String("Hello World!", 50, 40);
  
  mylcd.Set_Text_colour(YELLOW);
  mylcd.Set_Text_Size(2);
  mylcd.Print_Number_Float(1234.56,2,50, 48, '.', 0, ' ');
  
  mylcd.Set_Text_colour(RED);
  mylcd.Set_Text_Size(3);
  mylcd.Print_Number_Int(0xDEADBEF, 50, 64, 0, ' ', 16); 

  mylcd.Set_Text_colour(GREEN);
  mylcd.Set_Text_Size(4);  
  mylcd.Print_String("Groop", 50, 88); 

  mylcd.Set_Text_Size(2);
  mylcd.Print_String("I implore,", 50, 120);

  mylcd.Set_Text_Size(1);
  mylcd.Print_String("my foonting turling.", 50, 136);
  mylcd.Print_String("And hooptiously me", 50, 144);
  mylcd.Print_String("with crinkly bindle,", 50, 152);
  mylcd.Print_String("Or I will rend thee", 50, 160);
}
...
void rectangle_test(void)
{
  int i = 0;
   ...
   {
      mylcd.Draw_Rectangle(i,(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2+i+21,mylcd.Get_Display_Width()-1-i,mylcd.Get_Display_Height()-(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2-i+21);  
        delay(5);
   }
}
...
void fill_rectangle_test(void)
{
  int i = 0;
   mylcd.Fill_Screen(BLACK);
     mylcd.Set_Draw_color(YELLOW);
   mylcd.Fill_Rectangle(0,(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2+21,mylcd.Get_Display_Width()-1,mylcd.Get_Display_Height()-(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2+21);
   ...
   for(i = 0;i<mylcd.Get_Display_Width()/2;i+=4)
   {
      ...
      mylcd.Fill_Rectangle(i,(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2+i+21,mylcd.Get_Display_Width()-1-i,mylcd.Get_Display_Height()-(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2-i+21);  
        delay(5);
   }
}

void circles_test1(void)
{
  int i = 0;
   mylcd.Fill_Screen(BLACK);
     mylcd.Set_Draw_color(GREEN);
   for(i = 0;i<mylcd.Get_Display_Width()/2;i+=4)
   {
      mylcd.Draw_Circle(mylcd.Get_Display_Width()/2-1,mylcd.Get_Display_Height()/2-1+21, i); 
        delay(5);
   }
}

void fill_circles_test1(void)
{
  int i = 0;
   mylcd.Fill_Screen(BLACK);
   for(i = 0;i<mylcd.Get_Display_Width()/2;i+=4)
   {
       mylcd.Set_Draw_color(random(255), random(255), random(255));
      mylcd.Fill_Circle(mylcd.Get_Display_Width()/2-1,mylcd.Get_Display_Height()/2-1+21, mylcd.Get_Display_Width()/2-i); 
        delay(5);
   }
}
...
void triangles_test(void)
{
   ...
   for(i=0;i<mylcd.Get_Display_Width()/2;i+=5)
   {
      ...
      mylcd.Draw_Triangle(mylcd.Get_Display_Width()/2-1,mylcd.Get_Display_Height()/2-1-i+21,
                    mylcd.Get_Display_Width()/2-1-i,mylcd.Get_Display_Height()/2-1+i+21,
                    mylcd.Get_Display_Width()/2-1+i,mylcd.Get_Display_Height()/2-1+i+21);                   
   }
}
...
void fill_triangles_test(void)
{
    ...
    for(i=mylcd.Get_Display_Width()/2-1;i>0;i-=5)
   {
      ...
      mylcd.Set_Draw_color(0,i+64,i+64);
      mylcd.Fill_Triangle(mylcd.Get_Display_Width()/2-1,mylcd.Get_Display_Height()/2-1-i+21,
                    mylcd.Get_Display_Width()/2-1-i,mylcd.Get_Display_Height()/2-1+i+21,
                    mylcd.Get_Display_Width()/2-1+i,mylcd.Get_Display_Height()/2-1+i+21);                   
...
void round_rectangle(void)
{
     ...
     for(i = 0;i<mylcd.Get_Display_Width()/2;i+=4)
   {
      ...
      mylcd.Draw_Round_Rectangle(i,(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2+i+21,mylcd.Get_Display_Width()-1-i,mylcd.Get_Display_Height()-(mylcd.Get_Display_Height()-mylcd.Get_Display_Width())/2-i+21,8);
        delay(5);
   } 
}
