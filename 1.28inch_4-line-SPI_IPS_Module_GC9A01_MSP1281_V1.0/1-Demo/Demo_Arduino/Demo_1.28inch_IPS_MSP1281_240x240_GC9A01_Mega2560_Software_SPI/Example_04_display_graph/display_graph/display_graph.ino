...
void circles_test1(void)
{
  int i = 0;
   ...
   for(i = 0;i<mylcd.Get_Display_Width()/2;i+=4)
   {
      mylcd.Draw_Circle(mylcd.Get_Display_Width()/2-1,mylcd.Get_Display_Height()/2-1, i); 
        delay(5);
   }
}
...
void fill_circles_test1(void)
{
  int i = 0;
   ...
   {
       mylcd.Set_Draw_color(random(255), random(255), random(255));
      mylcd.Fill_Circle(mylcd.Get_Display_Width()/2-1,mylcd.Get_Display_Height()/2-1, mylcd.Get_Display_Width()/2-i); 
        delay(5);
   }
}
