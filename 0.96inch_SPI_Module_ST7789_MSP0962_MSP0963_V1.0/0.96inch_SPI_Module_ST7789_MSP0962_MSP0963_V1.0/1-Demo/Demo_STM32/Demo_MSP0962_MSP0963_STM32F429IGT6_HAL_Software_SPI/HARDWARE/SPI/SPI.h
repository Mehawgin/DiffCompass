...
/*---------软件SPI引脚定义-------------*/
//SCLK引脚定义
#define SPI_SCLK_PORT   GPIOF
#define SPI_SCLK_PIN    GPIO_PIN_7	//PF7--->>TFT --SCL/SCK

//MOSI引脚定义
#define SPI_MOSI_PORT   GPIOF
#define SPI_MOSI_PIN    GPIO_PIN_9	//PF9 MOSI--->>TFT --SDA/DIN
...
//拉低
#define	SPI_SCLK_CLR  	SPI_SCLK_PORT->BSRR=(uint32_t)SPI_SCLK_PIN<<16U    
#define	SPI_MOSI_CLR  	SPI_MOSI_PORT->BSRR=(uint32_t)SPI_MOSI_PIN<<16U    
