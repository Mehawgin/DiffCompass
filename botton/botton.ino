...
void text_test()
{
	...
	snprintf(text, sizeof(text), "@copyright by LinWei", button1.numberKeyPresses);
	mylcd.drawString(text, 50,90,2);
	mylcd.drawString("Mayracle5", 90,130,2);
	mylcd.drawString("&HANGZHOU", 85,150,2);
...
//
//		if (button1.numberKeyPresses > MODE_MAX_NUM)
//		{
