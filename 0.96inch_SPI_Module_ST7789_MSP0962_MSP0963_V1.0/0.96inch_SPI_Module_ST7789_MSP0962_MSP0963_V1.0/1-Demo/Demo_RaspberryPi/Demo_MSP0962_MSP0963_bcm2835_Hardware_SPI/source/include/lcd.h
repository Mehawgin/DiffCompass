...
#define LCD_CS   8          //chip selection control signal  bcm:8
...
#define LCD_LED_SET  bcm2835_gpio_write(LCD_LED,HIGH)
#define LCD_LED_CLR  bcm2835_gpio_write(LCD_LED,LOW)

#define LCD_RS_SET   bcm2835_gpio_write(LCD_RS,HIGH)
#define LCD_RS_CLR   bcm2835_gpio_write(LCD_RS,LOW)

#define LCD_RST_SET  bcm2835_gpio_write(LCD_RST,HIGH)
#define LCD_RST_CLR  bcm2835_gpio_write(LCD_RST,LOW)

#define LCD_CS_SET   bcm2835_gpio_write(LCD_CS,HIGH)
#define LCD_CS_CLR   bcm2835_gpio_write(LCD_CS,LOW)
