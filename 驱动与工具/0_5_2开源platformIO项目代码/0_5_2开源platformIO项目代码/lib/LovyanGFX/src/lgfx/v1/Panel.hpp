...
//----------------------------------------------------------------------------
  ...
  protected:
    ...
    /// @a ctg_basecolour ctg added on 2022-9-3
    RGBColor ctg_basecolour = 0u;
  public:
    IPanel(void) = default;
    ...
    /// @a setCtgPanelBaseColour ctg added on 2022-9-3
    void setCtgPanelBaseColour(uint32_t ctg_Tcolour){
      ctg_basecolour = getSwap24(ctg_Tcolour);
    }
 };
